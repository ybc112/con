...
export const STAKING_BANK_ABI = [
  ...
  "function lockAdminParams()",
  "function adminParamsLocked() view returns (bool)",
  "function sweepNative(address to)",
  ...
  // ============ 自定义错误（合约全部使用 custom error，无 require 字符串）============
  // 必须声明，否则 ethers v6 无法解码 revert 原因，用户只会看到
  // "execution reverted (unknown custom error)"，无法定位真实失败原因。
  "error NotOwner()",
  "error NotAdmin()",
  "error Reentrant()",
